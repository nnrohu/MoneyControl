...
public class DebtReminder {
    private static final int DEBT_REMINDER_INTERVAL_HOURS = 24;
    private static final int DEBT_REMINDER_INTERVAL_SECONDS = (int) (TimeUnit.HOURS.toSeconds(DEBT_REMINDER_INTERVAL_HOURS));
