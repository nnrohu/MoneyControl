...
public class DebtReminder {
    private static final int DEBT_REMINDER_INTERVAL_MINUTES = 1440;
    private static final int DEBT_REMINDER_INTERVAL_SECONDS = (int) (TimeUnit.MINUTES.toSeconds(DEBT_REMINDER_INTERVAL_MINUTES));
    private static final int SYNC_FLEX_SECONDS = DEBT_REMINDER_INTERVAL_SECONDS;

    private static final String REMINDER_JOB_TAG = "debt_reminder_tag";

    private static boolean sInitialized;

    public static void showNotificationReminder(@NonNull final Context context){
        ...
        Job constraintReminderJob = dispatcher.newJobBuilder()
                ...
                .setService(DebtReminderFirebaseJobService.class)
                /*
                ...
                .setTrigger(Trigger.executionWindow(
                        ...
                        DEBT_REMINDER_INTERVAL_SECONDS + SYNC_FLEX_SECONDS))
                /*
